...
/// The entry point of the declarative navigator example.
...
/// {@template app}
/// App widget for the declarative navigator example.
/// {@endtemplate}
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
    ...
    builder: (context, _) =>
        AppNavigator(home: AppPages.home.page, controller: controller),
  );
}
          ...
          actions: <Widget>[
            ...
            IconButton(
              ...
              onPressed: () => AppNavigator.change(
                context,
                (pages) => [AppPages.home.page, AppPages.settings.page],
              ),
            ),
          ],
        ),
